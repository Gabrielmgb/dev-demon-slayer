...
export default function EpisodiosPage() {
  ...
  const titleRef = useRef<HTMLHeadingElement>(null); // ref para o <h2>

  // Faz scroll quando a temporada muda
  useEffect(() => {
  ...
  return (
    <div>
      ...
      {/* Título da temporada com scroll */}
      <h2
        ref={titleRef}
        className="scroll-mt-24 text-neutral-200 text-2xl md:text-3xl font-bold mb-6 text-center px-4"
      >
